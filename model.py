...
class ActorModel(nn.Module):
    ...
    def __init__(self, input_size, output_size, seed, fc1_units=256, fc2_units=256):
        ...
        # atch Normalization allows us to use much higher learning rates and be less careful about initialization
        # It also acts as a regularizer, in some cases eliminating the need for Dropout
        # As described in Batch Normalization: Accelerating Deep Network Training by Reducing Internal Covariate Shift(https://arxiv.org/abs/1502.03167)
